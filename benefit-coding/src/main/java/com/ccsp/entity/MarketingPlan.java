 ...
 */
@Entity
@Table(name = "MarketingPlan", schema = "dbo", catalog = "ccsp", uniqueConstraints = {
    @UniqueConstraint(columnNames = "MktPlanId"), @UniqueConstraint(columnNames = "AdminPlanId")})
public class MarketingPlan implements java.io.Serializable {
  ...
  public MarketingPlan(byte[] nodeId, int mktPlanId, String mktPlanName, String mktPlanCoverage,
      Date mktPlanEffectiveDate, Date mktPlanExpirationDate, String mktPlanType,
  ...
  public MarketingPlan(byte[] nodeId, Short nodeLevel, int mktPlanId, Integer adminPlanId,
      String mktPlanName, String mktPlanCoverage, Date mktPlanEffectiveDate,
      Date mktPlanExpirationDate, String mktPlanType, String mktPlanLevelOfCoverage,
